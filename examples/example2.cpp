...
int main()
{
	...
	Shape shape1(geom1);
	shape1.setFaceColor(Color::IndianRed);
	shape1.setLiaisonColor(Color::Red);
	shape1.setLiaisonWidth(3);
	...
	Shape shape2(geom2);
	shape2.setFaceColor(Color::SpringGreen);
	shape2.setLiaisonColor(Color::DarkGreen);
	shape2.setLiaisonWidth(3);
